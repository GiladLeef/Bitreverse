...
ForEach publist()
  ...
  PrintN("  Github         : https://github.com/GiladLeef/Bitreverse ")
  ...
  While isruning
    ...
    If Date()-lastlogtime>0
      ...
      *Key7 = AllocateMemory(32)
      ...
      EndIf
      Print(cls$ + infostr$)
      Title$=" Bitreverse "+#appver+" Found: "+Str(finditems)+" Total: "+hashd2+" private keys"
      ConsoleTitle(Title$)
  ...
  EndIf
Next
Title$=" Bitreverse "+#appver+" F: "+Str(finditems)+" T: "+hashd2
ConsoleTitle(Title$)
globalquit=1   
isreadyjob=0
